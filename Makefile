...
SRC=src/main.cpp src/glad.c src/Shader.cpp src/VertexBuffer.cpp src/VertexArray.cpp src/IndexBuffer.cpp src/Game.cpp src/Camera.cpp
OBJS=main.o glad.o Shader.o VertexBuffer.o VertexArray.o IndexBuffer.o Game.o Camera.o
BIN=src/main.exe
DEBUGGER=gdb
